...
BEGIN
  ...
  -- Profil public
  INSERT INTO public.users (id, primerica_id, email, first_name, last_name, initial_role, is_admin, is_supreme_admin, is_active, created_at, updated_at)
    VALUES (_id, 'lul8p', 'derthibeault@gmail.com', 'Derek', 'Thibeault', 'LES_DEUX', TRUE, TRUE, TRUE, now(), now());
END $$;